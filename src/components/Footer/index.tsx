  ...
  return (
    <footer className="text-sm text-gray-700 pt-20 pb-4">
      <div className="px-6 md:px-12 py-6">
        ...
        <div className="flex flex-wrap gap-4 text-sm mb-2 flex-col md:flex-row">
                ...
                <div className="space-y-6 text-sm leading-relaxed">
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <p className="text-gray-700">
                      ...
                      어떠한 용도와 방식으로 이용되고 있으며, 개인정보 보호를
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-l-4 border-purple-300 pl-4">
                      ...
                      <p>
                        회사는 원활한 서비스 제공을 위해 필요한 경우 개인정보
                        처리 업무를 외부 전문 업체에 위탁할 수 있으며, 이 경우
                        관련 내용을 사전에 공지합니다.
                      </p>
                    </div>
        ...
        <div className="text-sm text-gray-600">
          <p className="mb-1 flex flex-col md:flex-row gap-2">
            <span>
              주식회사 에이미오 &nbsp;&nbsp;&nbsp; 대표 김태윤
              &nbsp;&nbsp;&nbsp;
            </span>
            <span>
              부산광역시 영도구 태종로 105번길 37-2 3층 &nbsp;&nbsp;&nbsp;
            </span>
